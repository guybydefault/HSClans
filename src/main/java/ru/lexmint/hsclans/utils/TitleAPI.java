...
/**
 * Code from Factions https://github.com/drtshock/Factions
...
public class TitleAPI {
    ...
    public TitleAPI() {
        ...
        try {
            ...
            supportsAPI = true;
            HSClans.instance.getLogger().log(Level.INFO, "Found API support for sending player titles :D");
        } catch (NoSuchMethodException e) {
            HSClans.instance.getLogger().log(Level.WARNING, "Didn't find API support for sending titles :( Will attempt reflection. No promises.");
        }
    }
