 ...
 */
class ClanChatCommand extends AbstractClanPlayerCommand {
     ...
     */
    public ClanChatCommand(String[] aliases, ClanRole requiredClanRole, String permission, int arguments, String usage) {
