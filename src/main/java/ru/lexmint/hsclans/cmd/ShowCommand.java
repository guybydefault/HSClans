...
class ShowCommand extends AbstractCommand {
    ...
    public ShowCommand(String[] aliases, String permission, int arguments, String usage) {
    ...
    public void perform(CommandSender sender, String[] subargs) {
        ...
        if (!academyList.isEmpty()) {
            clanMessenger.message("commands.show.academy", sender, academy);
        } else {
            clanMessenger.message("commands.show.no-academy", sender, academy);
        }
        clanMessenger.message("commands.show.members", sender, members);
    }
