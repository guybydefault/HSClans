...
class ClaimCommand extends AbstractClanPlayerCommand {
    /*
     ...
     */
    public ClaimCommand(String[] aliases, ClanRole requiredClanRole, String permission, int arguments, String usage) {
