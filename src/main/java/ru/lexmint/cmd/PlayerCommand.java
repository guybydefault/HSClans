...
public class PlayerCommand extends HSCCommand {
    ...
    public void perform(CommandSender sender, String[] subargs) {
        ...
        if (cpLayer != null) {
            ...
            HSClans.instance.getMessenger().message("commands.player.level", sender, cpLayer.getLevel().getName(), String.valueOf(cpLayer.getHSRateView()), String.valueOf((int) (cpLayer.getPvPRate() * 100)));
